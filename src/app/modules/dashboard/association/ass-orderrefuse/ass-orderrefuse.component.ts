...
@Component({
    selector: 'app-ass-orderrefuse',
    templateUrl: './ass-orderrefuse.component.html',
    styleUrls: ['./ass-orderrefuse.component.scss']
})
export class AssOrderrefuseComponent implements OnInit {
    confirmorder: any = {
        id: null,
        membernameTH: "",
        membernameEN: "",
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<AssOrderrefuseComponent>,
