...
@Component({
  selector: 'app-add-order1',
  templateUrl: './add-order1.component.html',
  styleUrls: ['./add-order1.component.scss']
})
export class AddOrder1Component implements OnInit {
  order: any = {
    id: null,
    membernameTH: "",
    membernameEN: "",
...
constructor(
    ...
    public dialogRef: MatDialogRef<AddOrder1Component>,
