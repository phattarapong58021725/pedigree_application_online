...
@Component({
  selector: 'app-add-order4',
  templateUrl: './add-order4.component.html',
  styleUrls: ['./add-order4.component.scss']
})
export class AddOrder4Component implements OnInit {
  order: any = {
    id: null,
    membernameTH: "",
    membernameEN: "",
...
constructor(
    ...
    public dialogRef: MatDialogRef<AddOrder4Component>,
