...
@Component({
  selector: 'app-add-order3',
  templateUrl: './add-order3.component.html',
  styleUrls: ['./add-order3.component.scss']
})
export class AddOrder3Component implements OnInit {
  order: any = {
    id: null,
    membernameTH: "",
    membernameEN: "",
...
constructor(
    ...
    public dialogRef: MatDialogRef<AddOrder3Component>,
