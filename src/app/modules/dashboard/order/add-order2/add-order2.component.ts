...
@Component({
  selector: 'app-add-order2',
  templateUrl: './add-order2.component.html',
  styleUrls: ['./add-order2.component.scss']
})
export class AddOrder2Component implements OnInit {
  order: any = {
    id: null,
    membernameTH: "",
    membernameEN: "",
...
constructor(
    ...
    public dialogRef: MatDialogRef<AddOrder2Component>,
